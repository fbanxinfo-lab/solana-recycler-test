I created this project to help recycle the junk meme coins that are circling the block chain if it works everyone should be better off
and if the devnet gives me more trouble here is the entire bee movie script
